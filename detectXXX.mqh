...
int detectArrow( string symbol, int timeFrame, int shift = 1 ) {
      double buyArrow = 2147483647;  //iCustom(symbol,timeFrame,"GoldTradePro",false,0,shift);
      double sellArrow = 2147483647; //iCustom(symbol,timeFrame,"GoldTradePro",false,1,shift);
